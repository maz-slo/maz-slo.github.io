...
export function Contact() {
  ...
  return (
    <section id="contact" className="relative z-10 px-6 py-32 lg:px-16">
      <motion.div
      ...
      >
        <p className="mb-3 text-sm font-semibold uppercase tracking-[0.12em] text-[var(--accent)]">{contact.eyebrow}</p>
        <h2 className="mb-6 font-['Plus_Jakarta_Sans'] text-[clamp(2.5rem,5vw,4.5rem)] font-bold leading-tight tracking-[-0.03em]">
          {contact.title}
        </h2>
